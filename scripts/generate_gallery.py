...
Validated Queries x (Chunker x Embedder x Reranker x Strategy x Model) --&gt; Answers
        ...
        <p>
            ...
            <strong>Claude Sonnet 4.6</strong> as the primary judge (best accuracy
            per dollar — 15&times; cheaper than Opus 4.7 with comparable correlation),
            and <strong>GPT-5.4 Mini</strong> as a cross-provider validator (r=0.553 at
            $0.0015/call, and cross-validates with Sonnet 4.6 at r=0.720). Two judges
            from different providers limits any single judge's bias from dominating the
            results.
        </p>
