"""Tests for GoogleTextEmbedder (google-genai SDK).

Mocks the google.genai Client to avoid network dependency.
Replaces old tests that used the deprecated google-generativeai SDK.
"""
...
class TestProtocolCompliance:
    """Test that GoogleTextEmbedder satisfies the Embedder protocol."""

    @patch("src.embedders.google_text.genai")
    def test_satisfies_embedder_protocol(self, mock_genai):
